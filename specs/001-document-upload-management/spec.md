...
- **FR-009**: The system MUST allow authorized users to download or preview documents they have access to and must deny access when the user lacks permission.
